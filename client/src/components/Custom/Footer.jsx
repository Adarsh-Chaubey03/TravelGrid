          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 text-left">
            ...
            <div className="space-y-6">
              ...
              <div className="flex space-x-4">
                ...
                <a
                  href="mailto:hello@travelgrid.com?subject=Hello%20TravelGrid&body=Hi%20TravelGrid,%0D%0A%0D%0AI%20would%20like%20to%20inquire%20about..."
                  aria-label="Email"
              ...
              <div className="space-y-4 flex flex-col justify-center items-left">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:support@travelgrid.com?subject=Support%20Request&body=Hi%20TravelGrid%20Support,%0D%0A%0D%0AI%20need%20help%20with..."
                      className="text-gray-300 text-sm hover:underline block"
                    >
        ...
        <div className="fixed bottom-4 right-4 z-50 animate-in slide-in-from-bottom-2 duration-300">
          <div
            className={`max-w-sm w-full rounded-lg shadow-xl border-l-4 p-4 flex items-center space-x-3 transition-all duration-300 ${
              isDarkMode ? "bg-slate-800 text-white border-slate-600" : "bg-white text-gray-900 border-gray-200"
