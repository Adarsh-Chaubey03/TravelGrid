...
// The array now uses a 'reviewKey' instead of a hardcoded 'review' string.
const testimonials = [
  {
    name: "Amit P.",
    avatar: "https://randomuser.me/api/portraits/men/32.jpg",
    reviewKey: "amitP", // <-- New key to pull translation from JSON
    rating: 5,
  },
  {
    name: "Sara L.",
    avatar: "https://randomuser.me/api/portraits/women/44.jpg",
    reviewKey: "saraL", // <-- New key to pull translation from JSON
    rating: 5,
  },
  {
    name: "John D.",
    avatar: "https://randomuser.me/api/portraits/men/65.jpg",
    reviewKey: "johnD", // <-- New key to pull translation from JSON
    rating: 4,
  },
  {
    name: "Priya S.",
    avatar: "https://randomuser.me/api/portraits/women/68.jpg",
    reviewKey: "priyaS", // <-- New key to pull translation from JSON
    rating: 5,
  },
];
...
                }`}
              >
                {/* Dynamically fetch the translated review using the reviewKey */}
                {t(`home.reviews.${testimonial.reviewKey}`)}
              </p>
...
                    key={idx}
                    className={`w-5 h-5 ${
                      idx < testimonial.rating ? "text-yellow-400" : "text-gray-500"
                    }`}
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
