...
function About() {
  ...
  const glassEffect = isDarkMode
    ...
    : "backdrop-blur-xl bg-white/60 border border-white/20 shadow-2xl";

  const glassHoverEffect = isDarkMode
    ? "hover:bg-white/10 hover:border-pink-400/50"
    : "hover:bg-white/80 hover:border-pink-400/50";

  return (
    <div className={`w-full overflow-hidden transition-all duration-300 mt-16 antialiased`}>
      {/* Hero Section */}
      <motion.div
      ...
      >
        <div className="text-center max-w-4xl mx-auto">
          <motion.h1
            ...
            className={`text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-6 tracking-tight transition-all duration-300 ${
          ...
          <motion.p
            ...
            className={`text-xl sm:text-2xl mb-8 leading-relaxed font-medium tracking-wide transition-all duration-300 ${
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="flex items-center mb-6">
                ...
                <h2 className={`text-3xl sm:text-4xl font-bold tracking-tight transition-all duration-300 ${
                  isDarkMode ? 'text-white' : 'text-gray-900'
                }`}>
                  Our <span className="text-pink-400">Mission</span>
                </h2>
              </div>
              <p className={`text-lg mb-6 leading-relaxed font-normal tracking-wide transition-all duration-300 ${
                isDarkMode ? 'text-gray-300' : 'text-gray-700'
              }`}>
              ...
              <p className={`text-lg leading-relaxed font-normal tracking-wide transition-all duration-300 ${
                isDarkMode ? 'text-gray-300' : 'text-gray-700'
              }`}>
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className={`${glassEffect} rounded-2xl p-8 text-center transform hover:scale-105 transition-all duration-300`}>
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className={`text-3xl sm:text-4xl font-bold mb-6 tracking-tight transition-all duration-300 ${
              isDarkMode ? 'text-white' : 'text-gray-900'
            }`}>
              Our <span className="text-pink-400">Story</span>
            </h2>
            <p className={`text-xl max-w-3xl mx-auto leading-relaxed font-medium tracking-wide transition-all duration-300 ${
              isDarkMode ? 'text-gray-300' : 'text-gray-700'
            }`}>
            ...
            {timeline.map((item, index) => (
              ...
              >
                <div className={`w-5/12 ${index % 2 === 0 ? 'text-right pr-8' : 'text-left pl-8'}`}>
                  <div className={`${glassEffect} ${glassHoverEffect} rounded-2xl p-6 transition-all duration-300`}>
                    <div className="flex items-center mb-2">
                      <div className="text-pink-400 mr-2">{item.icon}</div>
                      <span className="text-pink-400 font-bold text-lg tracking-wide">{item.year}</span>
                    </div>
                    <h3 className={`text-xl font-bold mb-2 tracking-tight transition-all duration-300 ${
                      isDarkMode ? 'text-white' : 'text-gray-900'
                    }`}>{item.title}</h3>
                    <p className={`font-normal tracking-wide transition-all duration-300 ${
                      isDarkMode ? 'text-gray-300' : 'text-gray-700'
                    }`}>{item.description}</p>
                  </div>
                </div>

                <div className={`absolute left-1/2 transform -translate-x-1/2 w-4 h-4 bg-pink-400 rounded-full border-4 ${
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map((member, index) => (
              <motion.div
                ...
                className={`${glassEffect} ${glassHoverEffect} rounded-2xl p-6 text-center transition-all duration-300`}
              >
                <div className="text-6xl mb-4">{member.avatar}</div>
                <h3 className={`text-xl font-bold mb-2 tracking-tight transition-all duration-300 ${
                  isDarkMode ? 'text-white' : 'text-gray-900'
                }`}>{member.name}</h3>
                <p className="text-pink-400 font-semibold mb-3 tracking-wide">{member.role}</p>
                <p className={`text-sm leading-relaxed font-normal tracking-wide transition-all duration-300 ${
                  isDarkMode ? 'text-gray-300' : 'text-gray-700'
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {achievements.map((achievement, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ scale: 1.05 }}
                className="bg-gradient-to-br from-pink-500 to-purple-600 rounded-2xl p-8 text-center text-white transform transition-all duration-300 shadow-2xl"
              >
                <div className="flex justify-center mb-4 text-white">
                  {achievement.icon}
                </div>
                <div className="text-3xl font-extrabold mb-2 tracking-tight">{achievement.number}</div>
                <div className="text-pink-100 font-semibold tracking-wide">{achievement.label}</div>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className={`text-xl max-w-2xl mx-auto leading-relaxed font-medium tracking-wide transition-all duration-300 ${
              isDarkMode ? 'text-gray-300' : 'text-gray-700'
            }`}>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
              className={`${glassEffect} ${glassHoverEffect} rounded-2xl p-8 transition-all duration-300`}
            >
              ...
              <p className={`mb-4 font-normal tracking-wide transition-all duration-300 ${
                isDarkMode ? 'text-gray-300' : 'text-gray-700'
              }`}>
              ...
              <a
                ...
                className="text-pink-400 hover:text-pink-300 transition-colors duration-200 font-semibold tracking-wide"
              >
      ...
      >
        <div className="max-w-6xl mx-auto">
          <motion.h2
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className={`text-3xl sm:text-4xl font-bold text-center mb-12 tracking-tight transition-all duration-300 ${
              isDarkMode ? 'text-white' : 'text-gray-900'
            }`}
          >
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                >
                  {/* Front */}
                  <div
                    className={`absolute inset-0 ${glassEffect} ${glassHoverEffect} rounded-2xl p-6 transition-all duration-300`}
                  ...
                  >
                    ...
                    <p className={`leading-relaxed font-normal tracking-wide ${
                      isDarkMode ? 'text-gray-300' : 'text-gray-700'
                    }`}>
                      {feature.description}
                    </p>
                  ...
                  {/* Back */}
                  <div
                    className="absolute inset-0 bg-gradient-to-br from-pink-600 to-purple-700 rounded-2xl p-6 border border-pink-400 flex flex-col items-center justify-center text-center hover:from-pink-500 hover:to-purple-600 transition-all duration-300 shadow-2xl"
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          <motion.h2
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className={`text-3xl sm:text-4xl font-bold mb-8 tracking-tight ${
              isDarkMode ? 'text-white' : 'text-gray-900'
            }`}
          >
            Part of{" "}
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className={`${glassEffect} rounded-2xl p-8`}
          >
            <p className={`text-lg mb-6 leading-relaxed font-normal tracking-wide ${
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <div className="bg-pink-500 text-white px-6 py-2 rounded-full font-semibold tracking-wide transform hover:scale-105 transition-transform duration-200 shadow-lg">
                Open Source
              </div>
              <div className="bg-purple-500 text-white px-6 py-2 rounded-full font-semibold tracking-wide transform hover:scale-105 transition-transform duration-200 shadow-lg">
                Community Driven
              </div>
              <div className="bg-blue-500 text-white px-6 py-2 rounded-full font-semibold tracking-wide transform hover:scale-105 transition-transform duration-200 shadow-lg">
                Learning Focused
              </div>
            </div>
          </motion.div>
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          >
            {techStack.map((tech, index) => (
              <motion.div
                ...
                className={`${tech.color} text-white px-6 py-3 rounded-xl font-semibold tracking-wide transition-all duration-300 cursor-pointer shadow-2xl backdrop-blur-sm`}
              >
                {tech.name}
              </motion.div>
            ))}
          ...
          >
            <p className={`mt-4 text-lg font-normal tracking-wide transition-all duration-300 ${
              isDarkMode ? "text-gray-300" : "text-gray-700"
            }`}>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ scale: 1.05 }}
                className={`${glassEffect} ${glassHoverEffect} rounded-2xl p-6 transition-all duration-300`}
              >
                <h4 className={`${item.color} font-bold mb-2 text-lg tracking-tight`}>
                  {item.title}
                </h4>
                <p className={`text-sm leading-relaxed font-normal tracking-wide ${
                  isDarkMode ? 'text-gray-300' : 'text-gray-700'
                }`}>
                  {item.desc}
                </p>
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          <motion.h2
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className={`text-4xl font-extrabold mb-4 tracking-tight transition-all duration-300 ${
              isDarkMode ? "text-white" : "text-gray-900"
            }`}
          >
          ...
          <motion.p
            ...
            transition={{ duration: 0.8, delay: 0.2 }}
            viewport={{ once: true }}
            className={`text-xl mb-8 font-medium tracking-wide transition-all duration-300 ${
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate("/")}
              className="bg-gradient-to-r from-pink-500 to-purple-600 text-white px-8 py-3 rounded-xl font-semibold tracking-wide hover:from-pink-600 hover:to-purple-700 transition-all duration-300 shadow-2xl"
            >
              Explore TravelGrid
            </motion.button>
            <motion.button
              ...
              className={`${glassEffect} border-2 border-pink-400 text-pink-400 px-8 py-3 rounded-xl font-semibold tracking-wide hover:bg-pink-400 hover:text-white transition-all duration-300`}
            >
              View on GitHub
            </motion.button>
          </motion.div>
