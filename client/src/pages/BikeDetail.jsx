...
const fallbackBike = {
  ...
  engineSize: "250 cc",
  city: "Bengaluru",import React, { useMemo, useState } from "react";
import { useLocation, useNavigate, useParams } from "react-router-dom";
import { useTheme } from "../context/ThemeContext";
import { ChevronLeft, ChevronRight, ArrowLeft, Info } from "lucide-react";
...
/**
 * FIXED: Moved InfoItem component definition here (before BikeDetail)
 * to ensure it's defined before it's used.
 */
