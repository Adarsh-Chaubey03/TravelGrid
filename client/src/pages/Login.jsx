      ...
      >
        <div className="max-w-md w-full">
          ...
          <div className="text-center mb-8 mt-4">
            <h1 className="text-3xl font-bold text-gray-700 mb-2">{t("login.title")}</h1>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="relative">
                <div className={`absolute inset-0 flex items-center`}>
                  <div className={`w-full border-t ${isDarkMode ? "border-white/20" : "border-black/20"}`}></div>
                </div>
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-black/60 text-white">{t("login.orContinue")}</span>
                </div>
              </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-700">
                {t("login.noAccount")}{" "}
                <Link to="/signup" className="text-pink-400 hover:text-pink-500 font-medium">
                  {t("login.signupHere")}
                </Link>
              </p>
            </div>
            <div className="mt-2 text-center">
              <p className="text-gray-700">
                ...
                <Link to="/forgot-password" className="text-pink-400 hover:text-pink-500 font-medium">
                  {t("login.clickHere")}
                </Link>
              </p>
            </div>
