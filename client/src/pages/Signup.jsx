                ...
                {formData.password && (
                  <div className="mt-2">
                    <div className="flex gap-1 h-1">
                      <div
                        className={`flex-1 rounded ${passwordStrength === 'weak'
                            ? 'bg-red-500'
                      ...
                      />
                      <div
                        className={`flex-1 rounded ${passwordStrength === 'medium'
                            ? 'bg-yellow-400'
                      ...
                      />
                      <div
                        className={`flex-1 rounded ${passwordStrength === 'strong' ? 'bg-green-500' : 'bg-gray-300 dark:bg-gray-600'
                          }`}
                      />
                    </div>
                    <p
  ...
  "
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span
                    className={`px-2 ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-white text-gray-600'
                      }`}
                  >
                    {t('signup.orContinue')}
                  </span>
